...
const FALLBACK_ICONS: Record<string, React.ComponentProps<typeof MaterialCommunityIcons>["name"]> = {
  ...
  "exclamationmark.shield": "shield-alert-outline",
  ...
  photo: "image-outline",
  plus: "plus",
  "plus.forwardslash.minus": "plus-minus-variant",
  ...
  safari: "apple-safari",
  "shield.fill": "shield",
  "shield.lefthalf.filled": "shield-half-full",
  sparkles: "creation",
  speedometer: "speedometer",
  "point.3.connected.trianglepath.dotted": "source-branch",
